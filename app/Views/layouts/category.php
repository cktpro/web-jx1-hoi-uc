...
<head>
    ...
    <meta property="og:title" content="<?= htmlspecialchars(($category['catTitle'] ?? '') . ' - ' . ($config['title'] ?? '')) ?>">
    ...
    <title><?= htmlspecialchars($category['catTitle'] ?? '') ?> - <?= htmlspecialchars($config['title'] ?? APP_NAME) ?></title>
